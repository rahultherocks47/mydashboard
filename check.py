...
username = "XG08763"  # fyers_id
password = "123$rocK"  # fyers_password
pin = 3233 # your integer pin
client_id = "F8QQEC8OV3-100"  # "L9NY****W-100" (Client_id here refers to APP_ID of the created app)
secret_key = "1E0WOPB0EV"  # app_secret key which you got after creating the app
redirect_uri = "http://localhost:2000"  # redircet_uri you entered while creating APP.
...
def setup():
    ...
    r1 = s.post("https://api.fyers.in/vagator/v2/login", data=data1)
    ...
    r2 = s.post("https://api.fyers.in/vagator/v2/verify_pin", data=data2)
